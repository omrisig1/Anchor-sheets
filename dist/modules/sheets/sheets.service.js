...
class SheetsService {
    setCell(sheet_id, column_name, cell_data) {
    ...
    logSheet(id) {
        var _db_sheet_columns;
        const method = "Service/logSheet";
        log.blue(`${method} - start`);
        const database = getDB();
        const db_sheet = database[id];
        const columns = (_db_sheet_columns = db_sheet.columns) === null || _db_sheet_columns === void 0 ? void 0 : _db_sheet_columns.map((column)=>{
            return {
                name: column.name,
